...
/*
     ...
     Planetas, Casas y Velocidades
     ./astrolog -qa 6 20 1975 23:00 3W 69W57 35S47
...
Item {
    ...
    UnikQProcess{
        ...
        function getGMS(jd){
            run('swetest -p'+r.c+' -j'+jd+' -geopos'+uqpJD.currentLon+','+uqpJD.currentLat+','+uqpJD.currentAlt+' -head -fZ')
    ...
    Component.onCompleted: {
        getData(d, m, a, h, min, lon, lat, alt, gmt)
